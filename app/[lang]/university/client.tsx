...
export default function UniversityClient({
  ...
  const filteredPosts = useMemo(() => {
    return posts.filter((post) => {
      ...
      const matchesCategory =
        selectedCategory === t.university.categories.all ||
  ...
  return (
    <div
      className="min-h-screen bg-[#031930] backdrop-blur-xl pt-24"
      style={{ backgroundColor: "#031930" }}
    >
      {/* Hero Section */}
      ...
      <section
        className="py-8 px-4 bg-white dark:bg-gray-800"
        style={{ backgroundColor: "white" }}
      >
        <div className="max-w-6xl mx-auto">
            ...
            {regularPosts.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 dark:text-gray-500">
                  {t.university.noArticlesFound.description}
                </p>
              </div>
            ) : (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      {/* Call to Action */}
      <section
        className="py-16 px-4 bg-[#031930] backdrop-blur-xl text-white"
        style={{ backgroundColor: "#031930" }}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              {t.university.finalCta.title}
            </h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              {t.university.finalCta.description}
            </p>
